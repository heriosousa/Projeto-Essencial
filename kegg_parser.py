...
class KeggParser():
    ...
    #    self.reac_len()
        ...
        for i in pairs:
            ...
            dir2 = 0
            #print(gen1,gen2)
            if(('ec' in gen1 and 'ec' in gen2) or (self.ref in gen1 and self.ref in gen2)):
                ...
                for j in self.ecproducts[gen2]:
                    if j in self.ecsubstrates[gen1]:
                        dir2 += 1
            elif(('ec' in gen1 and 'rn' in gen2) or (self.ref in gen1 and 'rn' in gen2)):
                for j in self.ecproducts[gen1]:
                ...
                for j in self.reactpro[gen2]:
                    if j in self.ecsubstrates[gen1]:
                        dir2 += 1
            elif(('rn' in gen1 and 'ec' in gen2) or ('rn' in gen1 and self.ref in gen2)):
